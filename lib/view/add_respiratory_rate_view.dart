...
import 'package:mapd722_group2_project/viewModel/add_respiratory_rate_vm.dart';
...
class AddRespiratoryRateView extends StatelessWidget with ValidatorMixin {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<AddRespiratoryRateVM>(
      create: (context) => AddRespiratoryRateVM(),
      child: Consumer<AddRespiratoryRateVM>(builder: (context, vm, child) {
        return Scaffold(
          appBar: AppBar(
            title: const Text('Add Respiratory Rate'),
          ),
